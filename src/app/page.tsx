...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-600 text-white rounded-full h-18 w-18 md:h-24 md:w-24 flex items-center justify-center text-center p-2 shadow-2xl z-20 border-4 border-white">
        <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest leading-tight">
